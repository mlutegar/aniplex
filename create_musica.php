...
<html lang="pt_BR">
  ...
  <head>
    ...
    <title>Formulário Cadastro de Musica</title>
  </head>
  ...
  <body style="background-color:#222529"><?php include("navbar.php");?>
    ...
    <section class="h-100">
      <form id="create-manga" action="createMusica.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-0" style="background-color: #24252a;">
                  ...
                  <div class="col-xl-6">
                    <div class="card-body p-md-5" style="color: #edf0f1;">
                      <h3 class="mb-5 text-uppercase">Cadastro da Musica</h3>
                      <div class="row">
                      ...
                      <div class="form-outline mb-4">
                        <input type="text" name="nome_musica" id="nome_musicaId" required class="form-control form-control-lg" />
                        <label class="form-label" for="form3Example8">Nome da Musica</label>
                      </div>
                      

                      <div class="form-outline mb-4">
                        <input type="text" name="anime" id="animeId" required class="form-control form-control-lg" />
                        <label class="form-label" for="form3Example8">Anime</label>
                      </div>
