...
<nav class="navbar navbar-expand-lg" style="background-color: #d1ebf7;">
  ...
  <a class="navbar-brand" href="index.php"><img width="100" height="104" class="d-inline-block align-text-top" src="img/aniplex logo.png" alt="logo"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form id="formSearchTitulo" class="d-flex" role="search" method="post" action="mangaLocalize.php">
        <input class="form-control me-2" type="search" id="searchTitulo" name="titulo" placeholder="Faça sua pesquisa" aria-label="Search">
